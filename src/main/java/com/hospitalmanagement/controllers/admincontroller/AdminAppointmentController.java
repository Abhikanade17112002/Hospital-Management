...
public class AdminAppointmentController {
    ...
    public ResponseEntity<String> deleteAppointmentById(@PathVariable(name = "appointmentId") String appointmentId ){
        return ResponseEntity.status(HttpStatus.OK)
                .body(appointmentService.deleteAppointmentById(appointmentId));
    }
}
