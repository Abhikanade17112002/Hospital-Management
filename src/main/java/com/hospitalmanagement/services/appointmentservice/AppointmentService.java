...
public class AppointmentService {
    ...
    public String deleteAppointmentById(String appointmentId) {
        if( !appointmentRepository.existsById(appointmentId) ){
            throw new EntityNotFoundException("Appointment With Appointment Id ==> " + appointmentId + " Not Found") ;
        }
        appointmentRepository.deleteById(appointmentId);
        return "Succesfully Deleted Appointment With Appointment Id ==> " + appointmentId ;
    }
}
